...
class DeviceCard extends Component {
    ...
    async refreshDevice() {
        ...
        this.timeoutIds.refreshDevice = setTimeout(
            () => this.refreshDevice(),
            timeoutWindow + Math.random() * timeoutWindow
        )
    }
    ...
    async _updateRole(event) {
        ...
        await axios.post('/api/devices/update/role/' + this.state.device.id, {
            role
        })
                        ...
                        <Row className='spacious'>
                            ...
                            <Col>
                                <span className='pull-right'>
                                    <TimeAgo
                                        date={this.props.device.last_seen}
                                    />
                                </span>
                            </Col>
                        </Row>
