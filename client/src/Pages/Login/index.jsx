            ...
            <>
                ...
                <Row className='centered spacious'>
                    <Col>
                        ...
                        >
                            <FontAwesomeIcon icon={['fab', 'github']} /> Login
                            with Github
                        </Button>
                    </Col>
                    <Col>
                        ...
                        >
                            <FontAwesomeIcon icon={['fab', 'google']} /> Login
                            with Google
                        </Button>
                    </Col>
                    <Col>
                ...
                <Row className='spacious'>
                    <Col>
                        To access TAC•OS, your membership account needs to be
                        linked to one of the providers above. You can link your
                        membership account below:
                        <br />
